 ...
 * .h5ebsd file.
 */
class ORIENTATIONANALYSIS_EXPORT ReadEDSDataFilter : public IFilter
{
public:
  ReadEDSDataFilter() = default;
  ~ReadEDSDataFilter() noexcept override = default;

  ReadEDSDataFilter(const ReadEDSDataFilter&) = delete;
  ReadEDSDataFilter(ReadEDSDataFilter&&) noexcept = delete;

  ReadEDSDataFilter& operator=(const ReadEDSDataFilter&) = delete;
  ReadEDSDataFilter& operator=(ReadEDSDataFilter&&) noexcept = delete;
  ...
  static inline constexpr StringLiteral k_Hdf5GroupPath_Key = "hdf5_eds_group_path";
  /**
...
SIMPLNX_DEF_FILTER_TRAITS(nx::core, ReadEDSDataFilter, "9b069816-79ac-47ce-93cb-e7966896bcbd");
